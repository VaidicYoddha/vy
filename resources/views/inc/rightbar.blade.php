                ...
                <div x-data="{activeTab:'tabHome'}"
                            ...
                            <div class="swiper mt-3 px-3"
                                ...
                                <div class="swiper-wrapper">
                                    <div
                                        ...
                                        <div class="grow">
                                            <img class="h-3" src="{{ asset('/dom')}}/images/payments/cc-visa-white.svg"
                                                alt="image" />
                                        </div>
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                                <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                    <div class="flex items-center space-x-2">
                                        <img class="h-10 w-10" src="{{ asset('/dom')}}/images/logos/bitcoin.svg"
                                            alt="image" />
                                        <div>
                                ...
                                <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                    <div class="flex items-center space-x-2">
                                        <img class="h-10 w-10" src="{{ asset('/dom')}}/images/logos/solana.svg"
                                            alt="image" />
                                        <div>
                                            <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                                                SOL
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-3 space-y-3 px-2">
                                <div
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar h-7 w-7">
                                                    <img class="rounded-full"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-20.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                    ...
                                    <img src="{{ asset('/dom')}}/images/object/object-18.jpg"
                                ...
                                <div
                                    ...
                                    <div class="flex flex-1 flex-col justify-between">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar h-7 w-7">
                                                    <img class="rounded-full"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-19.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                                    <p class="text-xs font-medium line-clamp-1">
                                    ...
                                    <img src="{{ asset('/dom')}}/images/object/object-2.jpg"
                                        class="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="flex flex-1 flex-col justify-between">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <div class="avatar h-7 w-7">
                                                    <img class="rounded-full"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-18.jpg"
                                                        alt="avatar" />
                                                </div>
                                                <div>
                                                    <p class="text-xs font-medium line-clamp-1">
                                    ...
                                    <img src="{{ asset('/dom')}}/images/object/object-1.jpg"
                                        class="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-show="activeTab === 'tabProjects'"
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                            <div class="flex items-center space-x-3">
                                <img class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="{{ asset('/dom')}}/images/illustrations/lms-ui.svg" alt="image" />
                                <div>
                                ...
                                <div class="flex -space-x-3">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-16.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-20.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                            <div class="flex items-center space-x-3">
                                <img class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="{{ asset('/dom')}}/images/illustrations/store-ui.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                        Store Dashboard
                                    </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-17.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-19.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                            <div class="flex items-center space-x-3">
                                <img class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="{{ asset('/dom')}}/images/illustrations/chat-ui.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                        Chat Mobile App
                                    </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-5.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-11.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                        ...
                        <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                            <div class="flex items-center space-x-3">
                                <img class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="{{ asset('/dom')}}/images/illustrations/nft.svg" alt="image" />
                                <div>
                                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                                        NFT Marketplace App
                                    </p>
                            ...
                            <div class="mt-3 flex items-center justify-between space-x-2">
                                <div class="flex -space-x-3">
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-8.jpg" alt="avatar" />
                                    </div>
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <div
                                    ...
                                    <div class="avatar h-7 w-7 hover:z-10">
                                        <img class="rounded-full ring ring-white dark:ring-navy-700"
                                            src="{{ asset('/dom')}}/images/avatar/avatar-12.jpg" alt="avatar" />
                                    </div>
                                </div>
                                <button
                                    class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                            ...
                            <li class="timeline-item">
                                ...
                                <div class="timeline-item-content flex-1 pl-4">
                                    ...
                                    <div class="mt-4 grid grid-cols-3 gap-3">
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-1.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-2.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-3.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-4.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-5.jpg"
                                            alt="image" />
                                        <img class="rounded-lg" src="{{ asset('/dom')}}/images/object/object-6.jpg"
                                            alt="image" />
                                    </div>
                                    <div class="mt-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 flex justify-between">
                                            <div class="flex flex-wrap -space-x-2">
                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-16.jpg"
                                                        alt="avatar" />
                                                </div>
                                                ...
                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-8.jpg"
                                                        alt="avatar" />
                                                </div>

                                                <div class="avatar h-7 w-7 hover:z-10">
                                                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                                                        src="{{ asset('/dom')}}/images/avatar/avatar-5.jpg"
                                                        alt="avatar" />
                                                </div>
                                            </div>
                                            <button
