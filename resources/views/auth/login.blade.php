...
<head>
    ...
    <title>Login Page - वैदिक यौद्धा</title>
   <link rel="icon" href="{{ asset('storage/logo/favicon.png') }}" type="image/png">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/front')}}/app-assets/css/plugins/forms/form-validation.css">
  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <a href="{{ url('/')}}" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ms-1" style="font-family: 'Rozha One', serif;">वैदिक यौद्धा</h2>
        </a>

        <h4 class="card-title mb-1">Welcome to Vaidic Yoddha! 👋</h4>
        ...
        <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-1">
            ...
            <input
              ...
              id="email"
              name="email"
              placeholder="arya@vaidicyoddha.com"
          ...
          <div class="mb-1">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="remember-me" {{ old('remember') ? 'checked' : '' }} tabindex="3" />
    ...
    <script src="{{ asset('/front')}}/app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('/front')}}/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
...
<!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/horizontal-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Sep 2022 06:54:00 GMT -->
</html>
